...
class MetricsLoggerKD:
    ...
    def log_metrics(self, student_size, epoch, training_loss, train_acc, avg_val_loss, val_acc, dataset_name, log_save_path, lr, T):
        self.ensure_directory_exists(log_save_path)
        ...
        json_file_path = f"{log_save_path}/KD_classification_metrics_T_{T}_lr_{lr}_student_size_{student_size}_{dataset_name}.json"
