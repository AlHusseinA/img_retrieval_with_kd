...
from schedulers.cosine import CosineAnnealingLRWrapper, CustomCosineAnnealingWarmUpLR
...
def main_resnet():
    ...
    for feature_size in feature_sizes:           
        ...
        if scheduler is not None:
            config_dict["scheduler"] = "CosineDecayLR"
            flag_scheduler = 1
        elif scheduler_var is not None:
            config_dict["scheduler"] = "CustomCosineAnnealingWarmUpLR"            
            config_dict["lr_warmup_epochs"] = lr_warmup_epochs
