...
from test_debug_retrieval_prob.similarities_only_debug_show_results import evaluate_on_retrieval_test_show_res
from test_debug_retrieval_prob.create_subset_dataloader_balanced_labels import filter_dataloader_cub200
from test_debug_retrieval_prob.create_subset_dataloader_labels2 import filter_dataloader_cub200_2
...
def main_resnet():
    ...
    filtered_loader_train, filtered_loader_test = filter_dataloader_cub200_2(data_root, batch_size=10, num_workers=10, n_labels=10)
    ...
    for feature_size in feature_sizes:
        ...
        model_cub200 = ResNet50_vanilla(num_classes_cub200, set_eval_mode=False, weights=ResNet50_Weights.DEFAULT, pretrained_weights=None)
        ...
        dir_van = "/home/alabutaleb/Desktop/confirmation/resnet50_feature_size_vanilla_cub200_batchsize_256_lr_7e.pth"
        ...
        fine_tuned_weights = torch.load(f'{dir_van}')
        ...
        if filtered_loader_test is not None:
            batch_size = 10

        results = evaluate_on_retrieval_test_show_res(model_cub200, testloader_cub200, filtered_loader_test, label_to_name_test, batch_size, device=device)
        ...
        retrieval_metrics_cub200[feature_size] = {'mAP': results['mAP'], 'R@1': results['R@1'], 
                                    'R@5': results['R@5'], 'R@10': results['R@10']}
        
    # print(f"{retrieval_metrics_cub200=}")
