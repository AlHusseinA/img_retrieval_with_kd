...
def image_retrieval(single_query_feature, gallery_features, device=None):
    ...
    print(f"###"*20)          
    print(f"You are in the beginngin of image_retrieval function and you using device: {device}")
    print(f"###"*20)
    ...
    print(f"###"*20)          
    print(f"You are in the middle of image_retrieval function and gallery_features is on device: {gallery_features.device}")
    print(f"You are in the middle of image_retrieval function and single_query_feature is on device: {single_query_feature.device}")
    ...
    print(f"You are in the middle of image_retrieval function and sorted_scores is on device: {sorted_scores.device}")
    print(f"You are in the middle of image_retrieval function and sorted_indices is on device: {sorted_indices.device}")   
    print(f"You are in the middle of image_retrieval function and similarity_scores is on device: {similarity_scores.device}")
    print(f"###"*20)
